...
|----------|------|-----|--------|
| `inject_incoming_requests_count` | `context_processors.py` | 11.8 | 🟡 Yellow |
| `inject_pending_tournament_invites` | `context_processors.py` | 11.8 | 🟡 Yellow |
| `_get_version_from_file` | `context_processors.py` | 10.2 | 🟡 Yellow |
