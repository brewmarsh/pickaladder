...
PROMPT_PATTERN = re.compile(r"CRAFT Prompt:\n(.*?)$", re.DOTALL)
...
def main():
    ...
    for match in SECTION_PATTERN.finditer(content):
        ...
        if issue_type == "High Cognitive Load":
            ...
            typing_tasks.append({"file": file_path, "prompt": prompt})
    ...
    print(
        f"Processing complete. {len(typing_tasks)} typing tasks written to typing_tasks.json."
    )
