...
class TestUserRoutes(unittest.TestCase):
    ...
    def _setup_dashboard_mocks(self, mock_db: MagicMock) -> None:
        ...
        self.mock_user_doc.collection("friends").where.return_value.stream.return_value = []
        self.mock_user_doc.collection("friends").where.return_value.where.return_value.stream.return_value = []
    ...
    def test_view_user_includes_doubles_and_processes_matches(
        ...
        mock_profile_user_ref.get.return_value.to_dict.return_value = {"username": "profile_user"}
