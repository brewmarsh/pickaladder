...
def test_tournament_flow(
    ...
    # Required field selection from main branch refactor
    ...
    # Create a friend to verify the Invite dropdown (From Main)
    ...
    # The URL is generated based on the address provided above
