...
Query.get = query_get  # type: ignore[assignment]
...
class MockTransaction(Transaction):
    ...
    def get(self, ref_or_query: Any, **kwargs: Any) -> Any:  # type: ignore[override]
        """Mock get."""
        return ref_or_query.get()

    def set(self, reference: Any, document_data: dict[str, Any], **kwargs: Any) -> None:  # type: ignore[override]
        """Mock set."""
        reference.set(document_data, **kwargs)

    def update(
        self, reference: Any, field_updates: dict[str, Any], **kwargs: Any
    ) -> None:  # type: ignore[override]
        """Mock update."""
        reference.update(field_updates)

    def delete(self, reference: Any, **kwargs: Any) -> None:  # type: ignore[override]
        """Mock delete."""
        reference.delete()
