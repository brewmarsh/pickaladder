...
| `_calculate_winning_streaks` | `pickaladder/group/utils.py` | 21.2 | 🔴 Red |
| `format_matches_for_dashboard` | `pickaladder/user/services.py` | 21.1 | 🔴 Red |
...
| `register` | `pickaladder/auth/routes.py` | 17.3 | 🟡 Yellow |
| `view_group` | `pickaladder/group/routes.py` | 16.9 | 🟡 Yellow |
...
| pickaladder/stats/services.py | 100% | ✅ |
| pickaladder/stats/__init__.py | 100% | ✅ |
| pickaladder/stats/routes.py | 100% | ✅ |
...
- **Type Safety**: Coverage is 60%. Prompt: 'Add explicit type signatures to all functions in `tests/test_prediction.py` to meet the 90% Type Safety Index requirement.'
...
- **Critical ACL**: Functions `format_matches_for_dashboard` have Red ACL (>20). Prompt: 'Refactor functions in `pickaladder/user/services.py` with high cognitive load to bring ACL below 10. Split complex logic and reduce function length.'
...
- **Critical ACL**: Functions `_calculate_winning_streaks` have Red ACL (>20). Prompt: 'Refactor functions in `pickaladder/group/utils.py` with high cognitive load to bring ACL below 10. Split complex logic and reduce function length.'
...
| tests/test_user.py | 100 ✅ |  |
| tests/test_tournament_utils.py | 100 ✅ |  |
| tests/test_prediction.py | 80 ✅ | Type Safety Index 60% < 90% (-20) |
| tests/test_proxy_fix.py | 100 ✅ |  |
...
| pickaladder/__init__.py | 90 ✅ | 2 Yellow ACL functions (-10) |
| pickaladder/utils.py | 100 ✅ |  |
...
| pickaladder/stats/services.py | 95 ✅ | 1 Yellow ACL functions (-5) |
| pickaladder/stats/__init__.py | 100 ✅ |  |
| pickaladder/stats/routes.py | 100 ✅ |  |
...
| pickaladder/group/forms.py | 100 ✅ |  |
| pickaladder/group/__init__.py | 100 ✅ |  |
| pickaladder/group/utils.py | 70 ✅ | 1 Red ACL functions (-15), 3 Yellow ACL functions (-15) |
| pickaladder/group/routes.py | 90 ✅ | 2 Yellow ACL functions (-10) |
