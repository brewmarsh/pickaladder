...
|----------|------|-----|--------|
| `inject_incoming_requests_count` | `context_processors.py` | 10.2 | 🟡 Yellow |
| `inject_pending_tournament_invites` | `context_processors.py` | 10.2 | 🟡 Yellow |
