...
test:
	docker compose -f docker-compose.yml -f docker-compose.test.yml exec web sh -c "pip install -r requirements-test.txt && python -m unittest discover tests"
...
run-scorecard:
	agent-score score pickaladder/ --verbosity detailed
