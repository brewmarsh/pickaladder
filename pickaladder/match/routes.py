...
def _populate_match_form_choices(
    ...
    """Populate player choices for the match form using strictly typed casting."""
...
def record_match() -> Any:
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            # Map form data into the backend-structured MatchSubmission model
            ...
            # Redirect prioritization: Tournament > Group > Summary
