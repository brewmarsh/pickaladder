...
class MatchService:
    ...
    def get_team_names(db: Client, team1_id: str, team2_id: str) -> tuple[str, str]:
        ...
        name1 = (
            ...
            if bool(t1_doc.exists)
            else "Team 1"
        )
        name2 = (
            (t2_doc.to_dict() or {}).get("name", "Team 2")
            if bool(t2_doc.exists)
            else "Team 2"
        )
        return name1, name2
