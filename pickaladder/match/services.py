...
class MatchService:
    ...
    def _record_match_batch(  # noqa: PLR0913
        ...
        p1_data: dict[str, Any] = p1_snapshot.to_dict() or {} if p1_snapshot else {}
        p2_data: dict[str, Any] = p2_snapshot.to_dict() or {} if p2_snapshot else {}
    ...
    def get_match_summary_context(db: Client, match_id: str) -> dict[str, Any]:
        ...
        m_dict: dict[str, Any] = cast(dict[str, Any], match_data)
        match_type = str(m_dict.get("matchType", "singles"))
        ...
        if match_type == "doubles":
            ...
            if player1_ref:
                ...
                if p1_doc.exists:
                    p1_data_dict = p1_doc.to_dict() or {}
                    player1_data = p1_data_dict
            ...
            if player2_ref:
                ...
                if p2_doc.exists:
                    p2_data_dict = p2_doc.to_dict() or {}
                    player2_data = p2_data_dict
