...
def view_tournament(tournament_id: str) -> Any:
    ...
    if invite_form.validate_on_submit() and "user_id" in request.form:
        ...
        try:
            # Main logic: uses g.user to authorize the single invite
...
def edit_tournament(tournament_id: str) -> Any:
    ...
    if form.validate_on_submit():
        ...
        # Using explicit update method from 'main' to match existing Service Layer
        ...
        if success:
            ...
            # If unauthorized, kick them back to the lobby
